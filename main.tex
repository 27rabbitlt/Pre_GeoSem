...
\begin{frame}
	\begin{center}
		\begin{tikzpicture}[scale=1.5]
			...
			\draw[thick, red] (-2,2) -- (2,-2) node[below left] {Hyperplane};

			% Positive class (above the line)
			\filldraw[blue] (-1,1.5) circle (1.5pt);
			\filldraw[blue] (0.5,1.2) circle (1.5pt);
			\filldraw[blue] (-1.5,0.5) circle (1.5pt);

			% Negative class (below the line)
			\filldraw[green!70!black] (1,-1.2) circle (1.5pt);
			\filldraw[green!70!black] (-0.5,-1.5) circle (1.5pt);
			\filldraw[green!70!black] (1.5,-0.5) circle (1.5pt);

			% Labels
			\node[blue] at (-1,1.7) {Class +1};
			\node[green!70!black] at (1.5,-1.7) {Class -1};
		\end{tikzpicture}
	\end{center}
\end{frame}
\end{document}
